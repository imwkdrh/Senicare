...
import { ACCESS_TOKEN, AUTH_PATH, CS_ABSOLUTE_PATH, CS_DETAIL_PATH, CS_PATH, CS_UPDATE_PATH, CS_WRITE_PATH, HR_DETAIL_PATH, HR_PATH, HR_UPDATE_PATH, MM_PATH, OTHERS_PATH } from './constants';
import { AUTH_ABSOLUTE_PATH } from './constants/index';
  ...
  return (
    <Routes>
      ...
      <Route path={CS_PATH} element={<MainLayout />}>
        ...
        <Route path={CS_UPDATE_PATH(':customNumber/update')} element={<>고객 정보 수정</>} />
      </Route>
      ...
      <Route path={HR_PATH} element={<MainLayout />}>
        ...
        <Route path={HR_UPDATE_PATH(':userId/update')} element={<></>} />
      </Route>
