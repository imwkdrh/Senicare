                    ...
                    <div className="input-container">
                        ...
                        <div className="input-box">
                            ...
                            <div className="input-area">
                                ...
                                />
                                <div id="user-id-button" className="input-button disable">
                                    중복 확인
                                </div>
                            </div>
                        ...
                        <div className="input-box">
                            ...
                            <div className="input-area">
                                ...
                                />
                                <div id="user-telnumber-button" className="input-button disable">
                                    전화번호 인증
                                </div>
                            </div>
                        ...
                        <div id="auth-number-box" className="input-box" style={{ display: 'none'}}>
                            ...
                            <div className="input-area">
                                ...
                                />
                                <div id="auth-number-button" className="input-button disable">
                                    인증 확인
                                </div>
                            </div>
