                ...
                <div className='main'>
                    <div className='table'>
                        <div className='th'>
                            ...
                            <div className='td-record-tool'>사용 용품</div>
                            <div className='td-record-tool-count'>개수</div>
                        </div>
                        ...
                        <div key={index} className='tr'>
                            ...
                            <div className='td-record-contents'>{careRecord.contents}</div>
                                <div className='td-record-tool'>{careRecord.usedToolName}</div>
                            <div className='td-record-tool-count'>{careRecord.count}</div>
                            </div>
                        )}
                </div>
                </div>
