...
export const CS_WRITE_ABSOLUTE_PATH = `${CS_PATH}/write`;
export const CS_DETAIL_ABSOLUTE_PATH = (customNumber: string | number) => `${CS_PATH}/${CS_DETAIL_PATH(customNumber)}`;
export const CS_UPDATE_ABSOLUTE_PATH = (customNumber: string | number) => `${CS_PATH}/${CS_DETAIL_PATH(customNumber)}/update`;
...
export const HR_UPDATE_ABSOLUTE_PATH = (userId: string) => `${HR_PATH}/${ HR_DETAIL_PATH(userId)}/update`;
